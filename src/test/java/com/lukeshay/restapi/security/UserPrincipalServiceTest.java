...
public class UserPrincipalServiceTest extends TestBase {
	...
	void loadUserByUsernameTest() {
		UserPrincipal validUsername = (UserPrincipal) userPrincipalService.loadUserByUsername(user.getUsername());
		UserPrincipal invalidUsername = (UserPrincipal) userPrincipalService.loadUserByUsername("ADJFLDKFJ");
